...
export default function SetUpForm({
  ...
  const setUpForm = (
    <form
      onSubmit={(event) => {
        modifyBudget(event, setMonthBudgetValue)
          ...
          .catch((error) => {
            ...
            setShowAlert({
              ...
              alert: createErrorAlert(
                'There was an error modifying the budget',
              ),
            });
          });
      }}
    >
      ...
      <h3>
        ...
        {monthBudgetValue ? monthBudgetValue : monthBudget}
      </h3>
      <br />
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'Essential Food buget'}
          defaultValue={typesBudget?.essential_food}
          id={'essential_food_budget'}
          name={types.ESSENTIAL_FOOD}
        />
      </FormControl>

      <br />
      <FormControl>
        <InputLabel htmlFor={types.NON_ESSENTIAL_FOOD}>
          Non Essential Food:
        </InputLabel>
        <input
          type="number"
          placeholder={'Non Essential Food budget'}
          defaultValue={typesBudget?.non_essential_food}
          id={'non_essential_food'}
          name={'non_essential_food'}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          ...
          defaultValue={typesBudget?.party}
          id={types.PARTY}
          name={types.PARTY}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'phone budget'}
          defaultValue={typesBudget?.phone}
          id={'phone'}
          name={types.PHONE}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          ...
          defaultValue={typesBudget?.insurance}
          id={'insurance'}
          name={types.INSURANCE}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'gift budget'}
          defaultValue={typesBudget?.gift}
          id={'gift'}
          name={'gift'}
        />
      </FormControl>
      <br />
      <FormControl>
        <InputLabel htmlFor={types.RECREATIONAL_PURCHASE}>
          Recreational Purchases Budget:
        </InputLabel>
        <input
          type="number"
          placeholder={'recreational_purchase budget'}
          defaultValue={typesBudget?.recreational_purchase}
          id={'recreational_purchase'}
          name={'recreational_purchase'}
        />
      </FormControl>
      ...
      <input
        ...
        defaultValue={typesBudget?.vacation}
        id={types.VACATION}
        name={types.VACATION}
      />
      <br />
      <FormControl>
        ...
        <input
          ...
          defaultValue={typesBudget?.savings}
          id={types.SAVINGS}
          name={types.SAVINGS}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          ...
          defaultValue={typesBudget?.investment}
          id={types.INVESTMENT}
      ...
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'medicine budget'}
          defaultValue={typesBudget?.medicine}
          id={types.MEDICINE}
          name={types.MEDICINE}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'clothes budget'}
          defaultValue={typesBudget?.clothes}
          id={types.CLOTHES}
          name={types.CLOTHES}
        />
      </FormControl>
      ...
      <FormControl>
        ...
        <input
          type="number"
          placeholder={'university budget'}
          defaultValue={typesBudget?.university}
          id={types.UNIVERSITY}
          name={types.UNIVERSITY}
        />
      </FormControl>
      <br />
      <FormControl>
        ...
        <input
          ...
          defaultValue={typesBudget?.other}
          id={'other'}
          name={'other'}
        />
      </FormControl>
