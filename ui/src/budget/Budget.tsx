...
export default function Budget() {
    ...
    const budgetCategories = [category1, category2, category3, category4, category5, category6];
    ...
    return (
        <Box sx={{ flex: 1, width: '100%', flexGrow: 1 }} component="form">
            ...
            <Stack direction={'row'} spacing={2} sx={{justifyContent: 'flex-end'}}>
                <Button variant={'outlined'} sx={{ backgroundColor: 'transparet', color: colors.grey[100], borderColor: colors.blueAccent[400]}}>Cancel</Button>
                <Button variant={'contained'} sx={{ backgroundColor: colors.greenAccent[500], color: colors.grey[900]}}>Save</Button>
            </Stack>
            </Container>
        </Box>
    )
