...
export default function DeleteExpenseConfirmationDialog({
  open,
  setOpen,
  expenseId,
  handleOnDelete,
}: IEditExpenseDialogProps) {
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          onSubmit: (event: React.FormEvent<HTMLFormElement>) => {
            ...
            submitRequestToDeleteExpense(expenseId as string, handleOnDelete)
              .then((someAlert) => {
              ...
              .catch((error) => {
                ...
                setShowAlert({
                  alert: createErrorAlert(
                    'Major Error, please contanct and administrator',
                  ),
                  show: true,
                });
              });
...
async function submitRequestToDeleteExpense(
  expenseId: string,
  handleOnDelete: (deletedId: string) => void,
) {
