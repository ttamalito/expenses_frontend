...
function descendingComparator(
  ...
  orderBy: keyof OneExpenseSummaryTypeDeclaration,
) {
...
export default function ExpensesDataTable({ expenses }: IExpenses) {
  ...
  const [orderBy, setOrderBy] =
    React.useState<keyof OneExpenseSummaryTypeDeclaration>('amount');
  ...
  const [
    openDeleteExpenseConfirmationDialog,
    setOpenDeleteExpenseConfirmationDialog,
  ] = React.useState(false);
  const [expenseToEdit, setExpenseToEdit] = React.useState<
    OneExpenseSummaryTypeDeclaration | undefined
  >(undefined);
  const [expensesFetched, setExpensesFetched] = React.useState<
    OneExpenseSummaryTypeDeclaration[]
  >([]);
  ...
  const handleClickOpenDeleteExpenseConfirmationDialog = (
    expense: OneExpenseSummaryTypeDeclaration,
  ) => {
  ...
  return (
    <>
                      ...
                      <TableCell align={'right'}>
                        ...
                        <Tooltip title={'Delete'}>
                          <IconButton
                            ...
                            size={'small'}
                            onClick={() => {
                              handleClickOpenDeleteExpenseConfirmationDialog({
                                ...row,
                              });
                            }}
                          >
      ...
      <DeleteExpenseConfirmationDialog
        open={openDeleteExpenseConfirmationDialog}
